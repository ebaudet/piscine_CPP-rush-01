...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtWindow_t, stringdata) + ofs \
...
const QMetaObject QtWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QtWindow.data,
      qt_meta_data_QtWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
